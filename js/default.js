  ...
  $(document).ready(function() {
      ...
      function MarginAdjust() {
          ...
          if ($(window).width() > CCS * 4) {
              ...
              $('.Title').css({ marginLeft: -($(window).width() - (CCS * 4)) / 2 })
              $('.BackgroundContainer').css({ marginLeft: ($(window).width() - (CCS * 4)) / 2 })
          } else if ($(window).width() > CCS * 3) {
              IndexAdjust = 3
              $('.Title').css({ marginLeft: -($(window).width() - (CCS * 3)) / 2 })
              $('.BackgroundContainer').css({ marginLeft: ($(window).width() - (CCS * 3)) / 2 })
          } else if ($(window).width() > CCS * 2) {
              IndexAdjust = 2
              $('.Title').css({ marginLeft: -($(window).width() - (CCS * 2)) / 2 })
              $('.BackgroundContainer').css({ marginLeft: ($(window).width() - (CCS * 2)) / 2 })
          } else if ($(window).width() > CCS * 1) {
              IndexAdjust = 1
              $('.Title').css({ marginLeft: -($(window).width() - (CCS * 1)) / 2 })
              $('.BackgroundContainer').css({ marginLeft: ($(window).width() - (CCS * 1)) / 2 })
          }
      }
    ...
    `;
          ...
          if (Inventory_Item_Only == 1) {
              ...
              $('.' + Name + '.Inventory_Item').css({ background: I.Title.BG_Color, color: I.Title.Text_Color })
...
setCookie("Keg", 0, 365)
      ...
      function Item(Name) {
          ...
          $('.' + Name).find('.Time').css({ background: Items[Name].Interval.Fill_Color })
          $('.' + Name).find('.Item_Title').css({ background: Items[Name].Title.BG_Color, color: Items[Name].Title.Text_Color })
          $('.' + Name + '.Inventory_Item').css({ background: Items[Name].Title.BG_Color, color: Items[Name].Title.Text_Color })
          $('.' + Name).parent().css({ borderColor: I.Border_Color })
          window.setInterval(function() {
              ...
              if (Items[Name].Cost.Default * HowManyAtATime > Items.Money.Total) {
                  $('.' + Name).find('.Item_Cost').css({ color: 'gray' })
              } else {
                  $('.' + Name).find('.Item_Cost').css({ color: 'blue' })
              }
              ...
              if (Items[Name].Dirt_Level_Upgrade_Cost > Items.Money.Total) {
                  $('.UpgradeDirt > .ItemWrap > .Inventory_Item.' + Name).css({ opacity: .4 })
              } else {
                  $('.UpgradeDirt > .ItemWrap > .Inventory_Item.' + Name).css({ opacity: 1 })
              }
          ...
          function Start(Name) {
              window.setInterval(function() {
                  ...
                  $('.' + Name).find('.Time').css({ width: Items[Name].Timer })
